    ...
    return (
      <Tooltip content={disabledTooltip}>
        ...
        >
          ...
          {shortcut && (
            <kbd
              className={cn('hidden rounded bg-gray-200 px-2 py-0.5 text-xs font-light text-gray-400 md:inline-block', {
      ...
      className={cn(
        ...
        props.disabled || loading
          ...
          : {
              ...
              'border-transparent text-gray-500 duration-75 hover:bg-gray-100': variant === 'outline',
      ...
      {shortcut && (
        <kbd
          className={cn('hidden rounded px-2 py-0.5 text-xs font-light transition-all duration-75 md:inline-block', {
            'bg-gray-700 text-gray-400 group-hover:bg-gray-100 group-hover:text-gray-500': variant === 'primary',
